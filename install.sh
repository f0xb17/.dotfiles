...
chmod a+x $PWD/config/i3/scripts/change_kb_layout.sh
chmod a+x $PWD/config/polybar/scripts/show_spotify.sh
chmod a+x $PWD/config/polybar/scripts/net_client_list.sh
